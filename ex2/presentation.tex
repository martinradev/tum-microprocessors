...
\item Privilege level has to checked
...
On x86: 4KB, 2MB, 1GB
\item 4KB page: 0xBAADA555 = BAADA (tag) . 555 (page offset)\\
Important: 555 is also the concatenation of cache set index and line offset on current Intel processors\\
\end{itemize}
\end{frame}
